"""OpenEM hybrid search index interface.

Wraps LanceDB for vector + full-text search over the OpenEM corpus.
This is the canonical location — downstream projects should import
